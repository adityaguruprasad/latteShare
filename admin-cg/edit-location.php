...
<body>
<div id="title">
    <h3>Edit Cafe Location</h3>
</div>
<div id="box">
    <form action="edit-page-loc.php">
        <input type="hidden" name="loc-id" value="<?php $currentrow = $results->fetch_assoc(); echo $currentrow['location_id'];?>">
        ...
        <select name="id" class="textbox">
            ...
            while($currentrow = $results->fetch_assoc()){
                echo "<option value='". $currentrow['location_id'] . "'>" . $currentrow["location"] . "</option>";
            }
            ?>
