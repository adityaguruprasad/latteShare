...
$sql = "SELECT * FROM cgView2 WHERE location_id=" . $_REQUEST['id'];
...
<div id="box">
    Edit Internet Availability:<br><br>
    <form action="update_internet.php">
        <input type="hidden" name="id" value="<?php echo $recorddata['internet_id'];?>">
        <input type="text" name="internet" class="textbox" value=" <?php echo $recorddata['internet'];?>">
        <br><br>
