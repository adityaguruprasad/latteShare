...
$sql = "SELECT * FROM cgView2 WHERE rewards_id=" . $_REQUEST['id'];
...
<div id="box">
    Edit rewards program:<br><br>
    <form action="update_rewards.php">
        <input type="hidden" name="id" value="<?php echo $recorddata['rewards_id'];?>">
        <input type="text" name="rewardprogram" class="textbox" value=" <?php echo $recorddata['rewardprogram'];?>">
        <br><br>
