...
<body>
<div id="title">
    <h3>Add Internet Availability</h3>
</div>
<div id="box">
    Enter the internet availability option you'd like to add. <br><br>
    <form action="insert_internet.php">
        New Internet Availability:
        <input type="text" name="internet" class="textbox">
        <br><br>
