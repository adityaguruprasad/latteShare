...
<div id="box">
    <form action="edit-page-seating.php">
        <input type="hidden" name="seatid" value="<?php $currentrow = $results->fetch_assoc(); echo $currentrow['seatingtype_id'];?>">
        What seating type do you want to edit? <br><br>
        <select name="id" class="textbox">
            <option>Select Seating Type </option>
            <?php
            ...
            while($currentrow = $results->fetch_assoc()){
                echo "<option value='". $currentrow['seatingtype_id'] . "'>" . $currentrow["seatingtype"] . "</option>";
            }
            ?>
