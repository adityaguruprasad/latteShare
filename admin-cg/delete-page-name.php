...
if($_REQUEST["confirm"] != "yes") {
    echo "<br><br>Please confirm you want to delete this cafe name. <br><br>";
    ?>
...
if($accsecurity != 'admin'){
    ...
    $sql = "DELETE FROM cafe_name WHERE name_id=" .
        $_REQUEST["recordid"] . ";";
 ...
 echo "<hr>SQL:<br>" . $sql;
    ...
    echo "Your cafe name was deleted. http://webdev.iyaclasses.com/~slfinnig/acad276/admin-cg/editing-latteShare.php";
    ?>
