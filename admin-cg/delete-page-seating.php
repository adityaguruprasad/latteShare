...
<body>
<?php
$outlet = $_REQUEST["seatingtype"];

if($_REQUEST["confirm"] != "yes") {
    echo "<br><br>Please confirm you want to delete this seating type. <br><br>";
    ?>
    <form action="delete-page-seating.php">
...
$sql = "DELETE FROM seating_type WHERE seatingtype_id=" .
    $_REQUEST["recordid"] . ";";
...
if(!$results) {
    ...
    echo "PROBLEM. Did NOT delete the seating type.";
    exit();
}

echo "Your seating type was deleted. ";
?>
