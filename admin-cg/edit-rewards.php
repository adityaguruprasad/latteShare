...
<body>
<div id="title">
    <h3>Edit Rewards Program</h3>
</div>
<div id="box">
    <form action="edit-page-rewards.php">
        <input type="hidden" name="rewardid" value="<?php $currentrow = $results->fetch_assoc(); echo $currentrow['rewards_id'];?>">
        What reward program option do you want to edit? <br><br>
        <select name="id" class="textbox">
            <option>Select Rewards Program</option>
            <?php
            ...
            while($currentrow = $results->fetch_assoc()){
                echo "<option value='". $currentrow['rewards_id'] . "'>" . $currentrow["rewardprogram"] . "</option>";
            }
            ?>
