...
$sql = "SELECT * FROM cgView2 WHERE outlet_id=" . $_REQUEST['id'];
...
<div id="box">
    ...
    <form action="update_outlet.php">
        <input type="hidden" name="id" value="<?php echo $recorddata['outlet_id'];?>">
        <input type="text" name="outlet" class="textbox" value=" <?php echo $recorddata['outlet'];?>">
        <br><br>
