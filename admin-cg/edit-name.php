...
<div id="box">
    <form action="edit-page-name.php">
        <input type="hidden" name="cafeid" value="<?php $currentrow = $results->fetch_assoc(); echo $currentrow['name_id'];?>">
        What cafe name do you want to edit? <br><br>
        <select name="id" class="textbox">
            <option>Select Cafe Name </option>
            <?php
            ...
            while($currentrow = $results->fetch_assoc()){
                echo "<option value='". $currentrow['name_id'] . "'>" . $currentrow["cafename"] . "</option>";
            }
            ?>
