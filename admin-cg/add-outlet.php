...
<body>
<div id="title">
    <h3>Add Outlet Availability</h3>
</div>
<div id="box">
    Enter the outlet availability option you'd like to add. <br><br>
    <form action="insert_outlet.php">
        New Outlet Availability:
        <input type="text" name="outlet" class="textbox">
        <br><br>
