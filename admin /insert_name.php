...
if(!$results){
    echo "ERROR --  new cafe did not save <br>";
    echo $mysql->error;
} else {
    echo "Saved your new cafe, <b style='color:#DD5F76;' >" . $_REQUEST["cafename"] . "</b> with an ID of " . $mysql->insert_id . ".";
}
?>
</body>
</html>
